...
# Discord channel and authentication info (copy from POSTtest.py)
url = DISCORD_CHANNEL_URL

headers = {
    # ...existing headers from POSTtest.py...
    "accept": "*/*",
...
cookies = {
    # ...existing cookies from POSTtest.py...
...
def make_command_data(command):
    # Optionally add a random suffix to avoid duplicate detection
...
def main():
    while True:
        for command in commands:
            data = make_command_data(command)
